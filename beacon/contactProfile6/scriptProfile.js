$(document).ready(function(){
 ...
 $('#callNotesWrapper').hide();
  ...
  $('#infoSectionTab').on('click', function(){
    $('#callNotesWrapper').hide();
    $('#infoWrapper').show();
    $('.callNotesBar span').removeClass('selected');
    $(this).addClass('selected');
  });

  $('#callNotesTab').on('click', function(){
    $('#infoWrapper').hide();
  ...
  $('.profileNameText').on('click', function(){
    $('#contactBizCard').show();
  });

  $('#contactBizCard .mdi-close').on('click', function(){
    $('#contactBizCard').hide();
  });

  $('#actionMenu').on('click', function(){
    $('#actionButtonGroup').show();
  });

  $('#actionButtonGroup .mdi-close').on('click', function(){
    $('#actionButtonGroup').hide();
  });

  ///////////////CALL NOTES////////////////
  $('#fakeCalendar').hide();
  $('.dropDownTextBox .mdi-calendar').on('click', function(){
    $('#fakeCalendar').show();
  });
  
  $('#fakeCalendar').on('click', function(){
    $('#fakeCalendar').hide();
  });
...
$('#callNotesButton').click(function(){
  $('#callNotesWrapper').show();
});
...
$('#sendResearchButton').click(function(){
