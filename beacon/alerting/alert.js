...
$(document).ready(function(){
	$('#allAlerts').click(function(){
		...
		$('#riskSummaryMy').text(Math.round(Math.random() * allTotalSummaryBoxTotals[0]));
		$('#riskSummaryDsk').text(Math.round(Math.random() * allTotalSummaryBoxTotals[0]));
		$('#riskSummaryCov').text(Math.round(Math.random() * allTotalSummaryBoxTotals[0]));
		$('#riskSummaryVip').text(Math.round(Math.random() * allTotalSummaryBoxTotals[0]));

		$('#tradeSummaryMy').text(Math.round(Math.random() * allTotalSummaryBoxTotals[1]));
		$('#tradeSummaryDsk').text(Math.round(Math.random() * allTotalSummaryBoxTotals[1]));
		$('#tradeSummaryCov').text(Math.round(Math.random() * allTotalSummaryBoxTotals[1]));
		$('#tradeSummaryVip').text(Math.round(Math.random() * allTotalSummaryBoxTotals[1]));

		$('#stratSummaryMy').text(Math.round(Math.random() * allTotalSummaryBoxTotals[2]));
		$('#stratSummaryDsk').text(Math.round(Math.random() * allTotalSummaryBoxTotals[2]));
		$('#stratSummaryCov').text(Math.round(Math.random() * allTotalSummaryBoxTotals[2]));
		$('#stratSummaryVip').text(Math.round(Math.random() * allTotalSummaryBoxTotals[2]));

		$('#salesSummaryMy').text(Math.round(Math.random() * allTotalSummaryBoxTotals[3]));
		$('#salesSummaryDsk').text(Math.round(Math.random() * allTotalSummaryBoxTotals[3]));
		$('#salesSummaryCov').text(Math.round(Math.random() * allTotalSummaryBoxTotals[3]));
		$('#salesSummaryVip').text(Math.round(Math.random() * allTotalSummaryBoxTotals[3]));

		$('#perfSummaryMy').text(Math.round(Math.random() * allTotalSummaryBoxTotals[4]));
		$('#perfSummaryDsk').text(Math.round(Math.random() * allTotalSummaryBoxTotals[4]));
		$('#perfSummaryCov').text(Math.round(Math.random() * allTotalSummaryBoxTotals[4]));
		$('#perfSummaryVip').text(Math.round(Math.random() * allTotalSummaryBoxTotals[4]));

		$('#prTrdSummaryMy').text(Math.round(Math.random() * allTotalSummaryBoxTotals[5]));
		$('#prTrdSummaryDsk').text(Math.round(Math.random() * allTotalSummaryBoxTotals[5]));
		$('#prTrdSummaryCov').text(Math.round(Math.random() * allTotalSummaryBoxTotals[5]));
		$('#prTrdSummaryVip').text(Math.round(Math.random() * allTotalSummaryBoxTotals[5]));

		$('#systmSummaryMy').text(Math.round(Math.random() * allTotalSummaryBoxTotals[6]));
		$('#systmSummaryDsk').text(Math.round(Math.random() * allTotalSummaryBoxTotals[6]));
		$('#systmSummaryCov').text(Math.round(Math.random() * allTotalSummaryBoxTotals[6]));
		$('#systmSummaryVip').text(Math.round(Math.random() * allTotalSummaryBoxTotals[6]));

		$('#mrktSummaryMy').text(Math.round(Math.random() * allTotalSummaryBoxTotals[7]));
		$('#mrktSummaryDsk').text(Math.round(Math.random() * allTotalSummaryBoxTotals[7]));
		$('#mrktSummaryCov').text(Math.round(Math.random() * allTotalSummaryBoxTotals[7]));
		$('#mrktSummaryVip').text(Math.round(Math.random() * allTotalSummaryBoxTotals[7]));
	});
    ...
    $('#closedAlerts').click(function(){
		...
		$('#riskSummaryMy').text(Math.round(Math.random() * closedTotalSummaryBoxTotals[0]));
		$('#riskSummaryDsk').text(Math.round(Math.random() * closedTotalSummaryBoxTotals[0]));
		$('#riskSummaryCov').text(Math.round(Math.random() * closedTotalSummaryBoxTotals[0]));
		$('#riskSummaryVip').text(Math.round(Math.random() * closedTotalSummaryBoxTotals[0]));

		$('#tradeSummaryMy').text(Math.round(Math.random() * closedTotalSummaryBoxTotals[1]));
		$('#tradeSummaryDsk').text(Math.round(Math.random() * closedTotalSummaryBoxTotals[1]));
		$('#tradeSummaryCov').text(Math.round(Math.random() * closedTotalSummaryBoxTotals[1]));
		$('#tradeSummaryVip').text(Math.round(Math.random() * closedTotalSummaryBoxTotals[1]));

		$('#stratSummaryMy').text(Math.round(Math.random() * closedTotalSummaryBoxTotals[2]));
		$('#stratSummaryDsk').text(Math.round(Math.random() * closedTotalSummaryBoxTotals[2]));
		$('#stratSummaryCov').text(Math.round(Math.random() * closedTotalSummaryBoxTotals[2]));
		$('#stratSummaryVip').text(Math.round(Math.random() * closedTotalSummaryBoxTotals[2]));

		$('#salesSummaryMy').text(Math.round(Math.random() * closedTotalSummaryBoxTotals[3]));
		$('#salesSummaryDsk').text(Math.round(Math.random() * closedTotalSummaryBoxTotals[3]));
		$('#salesSummaryCov').text(Math.round(Math.random() * closedTotalSummaryBoxTotals[3]));
		$('#salesSummaryVip').text(Math.round(Math.random() * closedTotalSummaryBoxTotals[3]));

		$('#perfSummaryMy').text(Math.round(Math.random() * closedTotalSummaryBoxTotals[4]));
		$('#perfSummaryDsk').text(Math.round(Math.random() * closedTotalSummaryBoxTotals[4]));
		$('#perfSummaryCov').text(Math.round(Math.random() * closedTotalSummaryBoxTotals[4]));
		$('#perfSummaryVip').text(Math.round(Math.random() * closedTotalSummaryBoxTotals[4]));

		$('#prTrdSummaryMy').text(Math.round(Math.random() * closedTotalSummaryBoxTotals[5]));
		$('#prTrdSummaryDsk').text(Math.round(Math.random() * closedTotalSummaryBoxTotals[5]));
		$('#prTrdSummaryCov').text(Math.round(Math.random() * closedTotalSummaryBoxTotals[5]));
		$('#prTrdSummaryVip').text(Math.round(Math.random() * closedTotalSummaryBoxTotals[5]));

		$('#systmSummaryMy').text(Math.round(Math.random() * closedTotalSummaryBoxTotals[6]));
		$('#systmSummaryDsk').text(Math.round(Math.random() * closedTotalSummaryBoxTotals[6]));
		$('#systmSummaryCov').text(Math.round(Math.random() * closedTotalSummaryBoxTotals[6]));
		$('#systmSummaryVip').text(Math.round(Math.random() * closedTotalSummaryBoxTotals[6]));

		$('#mrktSummaryMy').text(Math.round(Math.random() * closedTotalSummaryBoxTotals[7]));
		$('#mrktSummaryDsk').text(Math.round(Math.random() * closedTotalSummaryBoxTotals[7]));
		$('#mrktSummaryCov').text(Math.round(Math.random() * closedTotalSummaryBoxTotals[7]));
		$('#mrktSummaryVip').text(Math.round(Math.random() * closedTotalSummaryBoxTotals[7]));
	});
