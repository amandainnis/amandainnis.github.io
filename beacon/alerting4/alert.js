...
console.log(tickerBoxArray[0].ticker);
   ...
   // function makeTickerBox(name, alertCount, redDot) {
   // 		var newTicker = $('<div class="summaryBoxStock"><div class="summaryBoxLeft"><div class="stockBoxTitle">'+ name +'</div><div class="stockBorder"></div><div class="numberSummaryBoxStock">'+ alertCount +'</div></div><div class="transparentDot' + redDot '"></div></div>');
